...
const (
	...
	Reservation_DeleteReservationById_FullMethodName         = "/reservation/DeleteReservationById"
)
...
func (c *reservationClient) DeleteReservationByEmail(ctx context.Context, in *Emaill, opts ...grpc.CallOption) (*Emptyaa, error) {
	out := new(Emptyaa)
	err := c.cc.Invoke(ctx, Reservation_DeleteReservationByEmail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationClient) DeleteReservationById(ctx context.Context, in *Emaill, opts ...grpc.CallOption) (*Emptyaa, error) {
	out := new(Emptyaa)
	err := c.cc.Invoke(ctx, Reservation_DeleteReservationById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reservation_DeleteReservationByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reservation_DeleteReservationByEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Reservation_DeleteReservationById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reservation_DeleteReservationById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
